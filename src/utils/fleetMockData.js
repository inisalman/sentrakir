...
export const MEMBERSHIP_TIERS = {
  free: {
    ...
    priceLabel: 'Gratis',
    period: '',
    quota: '1 - 10 Kendaraan',
    vehicleLimit: 10,
    features: [
      'Hingga 10 data armada kendaraan',
  ...
  business: {
    ...
    period: '/ bulan',
    quota: '31 - 50 Kendaraan',
    vehicleLimit: 50,
    features: [
      'Hingga 50 data armada kendaraan',
